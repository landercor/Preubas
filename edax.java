...
class edax {
    ...
    public static void main(String[] args) {
        ...
        } else if (persona.edadAct.length >= 12 && persona.edadAct.length <= 17) { // Verificar si la persona es menor de edad
        ...
        // Verificar si la persona es menor de edad usando switch mas moderno
/*
        switch (persona.edadAct.length) {
            case 12, 13, 14, 15, 16, 17 ->
                System.out.println("personas menores de edad acceso denegado: " + persona.edadAct.length);
            case 18, 19 ->
                System.out.println("Usuario encontrado.");
            default ->
                System.out.println("Acceso permitido. " + persona.edadAct.length);
        }
         */
