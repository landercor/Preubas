...
class edax {
    ...
    public static void main(String[] args) {
        ...
        } else if (persona.edadAct[0] < 18) {
            System.out.println(("personas menores de edad acceso denegado: " + persona.edadAct[0]));
        } else if (persona.edadAct.length >= 20) {
            System.out.println("Usuario encontrado.");
        } else {
            System.out.println("Usuario no encontrado.");
        }else if (edadActual == 12 || edadActual == 15) {perosna.edadAct == 12 || persona.edadActual == 15
