...
class edax {
    ...
    int[] edadActual = {17, 18, 20, 40, 32, 54, 10, 21, 19, 16, 15, 45, 50, 28, 12};
    ...
    public static void main(String[] args) {
        ...
        for (int edadAct : persona.edadAct) {
            if (edadAct >= 18 && persona.tieneCuenta && !persona.estaBloqueado) {
                System.out.println("Acceso peromitido con rango de edad: " + edadAct);
            } else {
                System.out.println("Acceso denegado para rango de edad: " + edadAct);
            }
        }
